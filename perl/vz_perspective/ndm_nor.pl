...
system("./sd.sh $source $dest $node ndmli01 \&COMPRESS=EXT");
print "./sd.sh $source $dest $node ndmli01 \&COMPRESS=EXT\n";
} else {
system("./sd.sh $source $dest $node ndmli01");
print "./sd.sh $source $dest $node ndmli01\n";
}
...
system("./sh.sh $source_header $dest_header $node ndmli01");
print "./sh.sh $source_header $dest_header $node ndmli01\n"; 
$count++;
